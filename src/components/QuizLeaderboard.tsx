    ...
    <div className="bg-white rounded-3xl p-6 sm:p-7 border border-slate-200/80 shadow-sm space-y-5">
      ...
      {publishedProcesses.length === 0 ? (
        <div className="py-12 text-center text-slate-400 bg-slate-50/50 rounded-2xl border border-dashed border-slate-200">
          <span className="material-symbols-outlined text-4xl mb-2 text-slate-300">quiz</span>
          <p className="text-sm font-semibold text-slate-600">No process updates yet</p>
          <p className="text-xs text-slate-400 mt-1">
            Publish processes with quizzes to enable quiz leaderboards.
          </p>
        </div>
      ) : (
        <>
          ...
          {activeProcess && (
            <div className="p-3.5 rounded-2xl bg-gradient-to-r from-purple-50/70 via-slate-50 to-indigo-50/50 border border-purple-100 flex flex-wrap items-center justify-between gap-3 text-xs">
              ...
              <div className="flex items-center gap-3 text-slate-600 font-semibold">
                <span>{activeProcess.quiz?.questions?.length || 0} Questions</span>
                <span>•</span>
                <span>{activeProcess.quiz?.totalMarks || 0} Total Marks</span>
                <span>•</span>
